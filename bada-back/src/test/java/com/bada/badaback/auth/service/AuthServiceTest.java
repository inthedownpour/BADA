...
public class AuthServiceTest extends ServiceTest {
    ...
    void signup() {
        ...
        assertAll(
                ...
                () -> assertThat(findMember.getFamilyCode()).isEqualTo("AB1111") // 가족코드 생성구현 이후 변경 예정
        );
    }
    ...
    void join() {
        ...
        assertAll(
                ...
                () -> assertThat(findMember.getIsParent()).isEqualTo(1),
                () -> assertThat(findMember.getProfileUrl()).isEqualTo(null),
                () -> assertThat(findMember.getFamilyCode()).isEqualTo(authCode.getCode()) // 인증코드 생성구현 이후 변경예정
        );
    }
    ...
    void joinChild() {
        ...
        assertAll(
                ...
                () -> assertThat(findMember.getProfileUrl()).isEqualTo(null),
                () -> assertThat(findMember.getFamilyCode()).isEqualTo(authCode.getCode())
        );
    }
    ...
    void login() {
        ...
        assertAll(
                ...
                () -> assertThat(loginResponseDto.familyCode()).isEqualTo("AB1111"),
                () -> {

...
//  private final NotificationsService notificationsService;    // 알림 서비스 사용 DB 테이블 저장을 위한 service 사용
  private final EmitterRepository emitterRepository;          // 알림 저장 레포지토리

//  public void alarmListen(AlarmDto alarmDto) {
//    String userId = alarmDto.getUserId();
...
//    sseEmitters.forEach(
//        (key, emitter) -> {
//          emitterRepository.saveEventCache(key, alarmDtos);
//          sendToClient(emitter, key, alarmDtos);            // 클라이언트에게 알림 전송
//        }
//    );
//  }
